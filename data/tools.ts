...
export const TOOLS: Tool[] = [
  ...
  },
  {
    slug: "json-viewer",
    name: "JSON Viewer",
    description: "Validate and explore JSON with a collapsible tree view.",
    category: "data",
    icon: "lucide:boxes",
    keywords: ["json", "view", "tree", "validate", "inspect", "pretty", "nested"],
    accent: "#f59e0b",
    isNew: true,
  },
  {
    ...
    description: "Check WCAG contrast ratios between two colors for accessible design.",
    category: "visual",
    icon: "lucide:contrast",
    keywords: ["color", "contrast", "wcag", "accessibility", "ratio", "aa", "aaa", "readable"],
    accent: "#8b5cf6",
    isNew: true,
  },
  {
    slug: "ip-dns",
    name: "IP & DNS Lookup",
    description: "Find your public IP and resolve DNS records via Cloudflare DoH.",
    category: "network",
    icon: "lucide:globe-2",
    keywords: ["ip", "dns", "lookup", "resolve", "a", "aaaa", "mx", "txt", "ns", "cname"],
    accent: "#0ea5e9",
    isNew: true,
  },
  {
    ...
    description: "Turn any text into ASCII art with multiple FIGlet fonts.",
    category: "text",
    icon: "lucide:terminal",
    keywords: ["ascii", "art", "figlet", "text", "banner", "font", "title"],
    accent: "#22c55e",
    isNew: true,
  },
  {
    slug: "ast-explorer",
    name: "AST Explorer",
    description: "Parse JavaScript/TypeScript into an Abstract Syntax Tree and explore the structure interactively.",
    category: "developer",
    icon: "lucide:git-branch",
    keywords: ["ast", "abstract", "syntax", "tree", "babel", "parser", "javascript", "typescript"],
    accent: "#6366f1",
    isNew: true,
  },
  {
    slug: "load-tester",
    name: "Load Tester",
    description: "Send concurrent HTTP requests and measure latency, throughput, and reliability.",
    category: "network",
    icon: "lucide:gauge",
    keywords: ["load", "test", "performance", "latency", "rps", "concurrent", "http", "benchmark"],
    accent: "#f97316",
    isNew: true,
  },
  {
    slug: "wasm-explorer",
    name: "WASM Explorer",
    description: "Inspect WebAssembly binary modules — view sections, imports, exports, and hex structure.",
    category: "developer",
    icon: "lucide:binary",
    keywords: ["wasm", "webassembly", "binary", "module", "import", "export", "leb128"],
    accent: "#8b5cf6",
    isNew: true,
  },
  {
    ...
    category: "developer",
    icon: "lucide:database",
    keywords: ["database", "schema", "er", "diagram", "sql", "prisma", "table", "relationship"],
    accent: "#06b6d4",
    isNew: true,
  },
  {
    ...
    category: "network",
    icon: "lucide:radio",
    keywords: ["websocket", "ws", "wss", "realtime", "connect", "send", "message", "ping"],
    accent: "#10b981",
    isNew: true,
  },
  {
